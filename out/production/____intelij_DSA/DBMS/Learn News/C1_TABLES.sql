CREATE TABLE IF NOT EXISTS "author" (
    ...
    "author_email" varchar(30) NOT NULL, -- author_email – email address of the author.
...
CREATE TABLE IF NOT EXISTS "subscriber" (
    ...
    "subscriber_email" varchar(30) NOT NULL, -- subscriber_email – email address of the subscriber, they can receive updates from the site through their email address.
    ...
    "date_joined" date NOT NULL, -- date_joined – the registration date of the subscriber.
    "date_approved" date NOT NULL, -- date_approved – the account will be reviewed by the administrator and this column refers to the approval date.
...
CREATE TABLE IF NOT EXISTS "news" (
    ...
    "date_posted" date NOT NULL, -- date_posted – this column refers to the posting date of the news or article.
    ...
    "date_updated" date NOT NULL, -- date_updated – this will record the date when the author updates the contents of the news.
...
CREATE TABLE IF NOT EXISTS "comment" (
    ...
    "comment_date" date NOT NULL, -- comment_date – the posting date of the comment.
